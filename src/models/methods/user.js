...
import { StepVerificationModel } from '../2step-verification';
import { ContactUsModel } from '../contactus';
import { ReportModel } from '../report';
import { ProductModel } from '../product';
import { ReviewModel } from '../review';
import { deleteImage } from '../../middlewares/filesUploads';
...
async function deleteUser() {
  deleteImage(`./uploads${this.image}`);
...
export default { setUserMethodsToSchema };
